                ...
                <div class="oc-item">
                    <div class="entry">
                        ...
                        <div class="entry-title title-sm nott">
                            ...
                            <h3>
                                <a target="_blank" href="<?php echo base_url('news/detail/' . $news['newsURL']) ?>" title="<?php echo str_replace('"', '', $news['newsTitle']); ?>">
                                    <?php
                        ...
                        <div class="entry-content ">
                            <a target="_blank" href="<?php echo base_url('news/detail/' . $news['newsURL']) ?>" class="button button-border button-rounded">ดูรายละเอียดเพิ่มเติม</a>
                        </div>
                    </div>
                </div>
            <?php } ?>
