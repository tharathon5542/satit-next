    ...
    <div class="col-lg-8 col-xlg-9 col-md-7">
        <div class="card animated bounceInRight" style="animation-delay: 0.3s;">
            ...
            <ul class="nav nav-tabs profile-tab" role="tablist">
                <li class="nav-item"> <a class="nav-link active" data-bs-toggle="tab" href="#profile" role="tab">ข้อมูลสาขา</a></li>
                <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#coordiantor" role="tab">ข้อมูลผู้ประสานงาน</a></li>
        ...
        $("#profileForm").validate({
            ...
            submitHandler: function(form) {
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "<?php echo base_url('crud/ProfileMajor/onEditProfileMajor') ?>",
                            method: "POST",
        ...
        $("#coordinatorForm").validate({
            ...
            submitHandler: function(form) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "<?php echo base_url('crud/ProfileMajor/onEditMajorCoordinator') ?>",
                            method: "POST",
                            data: new FormData(form),
                            dataType: "json",
                            contentType: false,
        ...
        $("#settingForm").validate({
            ...
            submitHandler: function(form) {
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "<?php echo base_url('crud/ProfileMajor/onEditMajorPassword') ?>",
                            method: "POST",
                            data: new FormData(form),
                            contentType: false,
                            processData: false,
