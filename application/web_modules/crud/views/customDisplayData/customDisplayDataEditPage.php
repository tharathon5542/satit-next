<div id="customDisplayDataEditModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">แก้ไขข้อมูลผลการดำเนินงาน</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
            </div>
            <div class="modal-body">
                <div class="card">
                    <div class="card-body">
                        <form id="editCustomDisplayDataForm" novalidate>
                            <input type="hidden" id="customDisplayDataID" name="customDisplayDataID">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="กรุณาป้อนหัวข้อผลการดำเนินงาน" id="dataTitle" name="dataTitle" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="กรุณาป้อนปริมาณข้อมูล" id="data" name="data" required>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">หน่วย</label>
                                        <input type="text" class="form-control" placeholder="กรุณาป้อนหน่วย" id="unit" name="unit" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="ตัวอย่าง icon-line-github" id="icon" name="icon" required>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">สีการ์ด</label>
                                        <input class="form-control d-block" type="color" id="color" name="color">
                                    </div>
                                </div>
                            </div>
...
<script>
    $('#customDisplayDataEditModal').on('hidden.bs.modal', function() {
        $('#modal-container').html('');
    })

    $("#editCustomDisplayDataForm").validate({
        ...
        submitHandler: function(form) {
            $.ajax({
                url: "<?php echo base_url('crud/CustomDisplayData/onEditCustomDisplayData') ?>",
                method: "POST",
                ...
                success: function(response) {
                    ...
                    showSuccessSweetalert('สำเร็จ!', 'แก้ไขข้อมูลผลการดำเนินงานแล้ว', 1500);
                    setTimeout(function() {
                        $('#customDisplayDataTable').DataTable().ajax.reload();
                        $('#customDisplayDataEditModal').modal('hide');
                    }, 1500)
                },
