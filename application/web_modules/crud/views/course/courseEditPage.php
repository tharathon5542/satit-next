<div id="courseEditModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">แก้ไขข้อมูลหลักสูตร CWIE</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
            </div>
            <div class="modal-body">
                <div class="card wizard-content">
                    <div class="card-body">
                        <form id="editCourseForm" class="validation-wizard wizard-circle" novalidate>
                            <!-- Step 1 -->
                            <h6>ข้อมูลหลักสูตร</h6>
                            <section>
                                <input type="text" id="courseID" name="courseID" required readonly hidden>
                                <?php if ($this->session->userdata('crudSessionData')['crudPermission'] == 'admin') { ?>
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <select id="courseMajorID" name="courseMajorID" class="form-select" required>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select id="courseYear" name="courseYear" class="form-select" required>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="กรุณาป้อนรหัสหลักสูตร" id="courseCode" name="courseCode">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label">ระดับการศึกษา</label>
                                            <select id="courseGrade" name="courseGrade" class="form-select">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="กรุณาป้อนชื่อหลักสูตร" id="courseName" name="courseName" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group">
                                        <label class="form-label">ชื่อหลักสูตร (ภาษาอังกฤษ)</label>
                                        <input type="text" class="form-control" placeholder="กรุณาป้อนชื่อหลักสูตรภาษาอังกฤษ" id="courseNameEN" name="courseNameEN">
                                    </div>
                                </div>
                            </section>
                            <!-- Step 2 -->
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select id="courseISCED" name="courseISCED" class="form-select">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select id="courseCwieCategory" name="courseCwieCategory" class="form-select">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="courseHardSkills" name="courseHardSkills" rows="5" placeholder="กรุณาป้อนข้อมูลทักษะด้านวิชาชีพ"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="courseSoftSkills" name="courseSoftSkills" rows="5" placeholder="กรุณาป้อนข้อมูลทักษะด้านการบริหารจัดการความคิดและอารมณ์"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select id="courseProfession" name="courseProfession" class="form-select">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="tags-default">
                                                <input type="text" id="courseTags" name="courseTags" placeholder="เพิ่มคำค้นหา" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="กรุณาป้อนรหัสอ้างอิง CHECO" id="courseChecoCode" name="courseChecoCode">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label">วันที่รับทราบ</label>
                                            <input type="date" class="form-control" placeholder="กรุณาป้อนวันที่รับทราบ" id="courseChecoAcknowledge" name="courseChecoAcknowledge">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="กรุณาป้อนประเภทการดำเนินการ" id="courseChecoOperation" name="courseChecoOperation">
                                        </div>
                                    </div>
                                </div>
                            </section>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="courseCoordinatorEmail" name="courseCoordinatorEmail" placeholder="กรุณาป้อนข้อมูลอีเมลผู้ประสานงาน">
                                        </div>
                                    </div>
                                </div>
                            </section>
...
<script>
    ...
    $(".validation-wizard").steps({
        ...
        onFinished: function(event, currentIndex) {
            Swal.fire({
                title: 'แจ้งเตือน',
                text: 'ยืนยันการแก้ไขข้อหลักสูตร?',
                type: 'warning',
                ...
                if (result.value) {
                    $.ajax({
                        url: "<?php echo base_url('crud/course/onEditCourse') ?>",
                        method: "POST",
                        data: form.serialize(),
                        dataType: "json",
                        beforeSend: function() {
                        ...
                        success: function(response) {
                            ...
                            showSuccessSweetalert('สำเร็จ!', 'แก้ไขข้อมูลหลักสูตรแล้ว', 1500);
                            setTimeout(function() {
